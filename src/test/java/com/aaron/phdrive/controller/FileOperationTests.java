...
public class FileOperationTests {
	...
	private final String TEST_FILEPATH = "/" + TEST_FILENAME;
	...
	public void shouldSaveUploadedFile() throws Exception {
		MockMultipartFile multipartFile = new MockMultipartFile("file", TEST_FILENAME,
				"text/plain", "Spring Framework".getBytes());
		this.mvc.perform(multipart(TEST_FILEPATH).file(multipartFile))
	...
	public void shouldDeleteFile() throws Exception {
		given(this.storageService.load(TEST_FILENAME))
			.willReturn(Paths.get(TEST_FILEPATH));
